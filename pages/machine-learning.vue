  ...
  <div style="background-color:#f5f5f5">
    ...
    <div v-if="$vuetify.breakpoint.width>600" class="header-section d-flex flex-row elevation-5 pa-10">
      ...
      <div style="width:95%">
        ...
        <p class="title-section text-center " style="position:relative;z-index:2"> MACHINE LEARNING</p>
    ...
    <v-app-bar v-else class="elevation-3 app-bar "  app clipped-left flat light style="z-index:99;width:100%;background-color:white">
        <v-icon @click="$router.push('/')" style="margin:auto;color:#14213D" size="30"> mdi-arrow-left</v-icon>
      <v-spacer></v-spacer>
        <p class="font-weight-bold"> Machine Learning </p>
    </v-app-bar>
...
export default {
  data(){
    return{
      dataMicro:[
        {name:'Image Classification', img:[{src:'/rps.png'},], year:'2021', as:'ML Developer', kindOfProject: 'Self Learning', detail:"Image classification for rock, paper and scissors", stack:['Pyhton','Matplotlib','Sklearn','tensorflow']},
      ],
      techStack:[
        {name: 'Python', img:'/tech-stack/python.png', url:''},
