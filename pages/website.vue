  ...
  data(){
    return{
      dataWebsite:[
        ...
        {name:'Dealku Legal', url:'https://deal-ku.com/landing-page', img:[{src:'/dealku-1.png'},{src:'/dealku-2.png'},{src:'/dealku-3.png'},{src:'/dealku-4.png'},{src:'/dealku-5.png'}],year:'2024', as:'Frontend Developer', kindOfProject: 'Freelance', detail:"Dealku Legal's website, owned by a law firm under GGP Law firm, serves to showcase Dealku's services. In addition to this, the platform offers a feature for users to submit legal questions, which will be addressed by Dealku's advocates. It also facilitates online consultations and includes a dashboard for admins and users to streamline data collection to make it easier to organize data for all of activites involved on this website.", stack:['Nuxt.JS','Vuetiy','MYSQL']},
